...
function JoinUs() {
  return (
    <div className='JoinUs'>
      <div className="join-controler">
      <svg className='blue-box-ath' width="294" height="282" viewBox="0 0 294 282" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="159.928" y="39.644" width="99" height="199.053" rx="29.5" transform="rotate(34.2964 159.928 39.644)" stroke="black"/>
...
<svg className='yellow-ath' width="108" height="139" viewBox="0 0 108 139" fill="none" xmlns="http://www.w3.org/2000/svg">
