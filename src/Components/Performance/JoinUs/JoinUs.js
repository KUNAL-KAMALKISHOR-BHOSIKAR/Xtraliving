...
function JoinUs() {
  return (
    <div className='JoinUs-leader'>
      <div className="join-control">
      <svg className='blue-box' width="294" height="282" viewBox="0 0 294 282" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg className='yellow-per' width="108" height="139" viewBox="0 0 108 139" fill="none" xmlns="http://www.w3.org/2000/svg">
